...
class SuperMenuButton extends JButton {
	...
	ImageIcon agendaIcon = resizeImage("TO_DO_App/src/main/resources/Img/SuperMenu/agenda.png", 50, 50);
	ImageIcon spacesIcon = resizeImage("TO_DO_App/src/main/resources/Img/SuperMenu/spaces.png", 50, 50);
	ImageIcon historyIcon = resizeImage("TO_DO_App/src/main/resources/Img/SuperMenu/history.png", 50, 50);
	ImageIcon analyticsIcon = resizeImage("TO_DO_App/src/main/resources/Img/SuperMenu/analytics.png", 50, 50);
	ImageIcon settingsIcon = resizeImage("TO_DO_App/src/main/resources/Img/SuperMenu/settings.png", 50, 50);
