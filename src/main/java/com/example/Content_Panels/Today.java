...
public class Today extends JPanel {
	...
	public Today() {
		...
		this.addComponentListener(new java.awt.event.ComponentAdapter() {
			public void componentResized(java.awt.event.ComponentEvent evt) {
				addTask.setBounds(getWidth() / 7 - 10, 240, 150, 30);
			}
		});
		...
		this.addComponentListener(new java.awt.event.ComponentAdapter() {
			public void componentResized(java.awt.event.ComponentEvent evt) {
				completed.setBounds(getWidth() / 7, 350, 150, 40);
			}
		});

		// completed.setBorder(border);
	...
	public void paint(Graphics g) {
		...
		g2D.drawLine(getWidth() / 7, 230, getWidth() - getWidth() / 7, 230);
		g2D.drawLine(getWidth() / 7, 400, getWidth() - getWidth() / 7, 400);
